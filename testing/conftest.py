...
def sample_params():
    ...
    return {
        ...
        "ssh_port": 22,
        "telnet_port": 23,
        "ssh_key": "/tmp/fake-secrets_example/ssh_key",
        "ca_cert": "/tmp/fake-secrets_example/ca.crt",
        "client_cert": "/tmp/fake-secrets_example/client.crt",
        "client_key": "/tmp/fake-secrets_example/client.key",
